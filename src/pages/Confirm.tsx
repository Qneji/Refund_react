...
export function Confirm() {
  ...
  return (
    <div className="bg-gray-500 lg:w-120 rounded-xl flex flex-col items-center p-10 gap-6">
      ...
      <p className="text-sm text-gray-200 text-center">
        Agora é apenas aguardar! Sua solicitação será enviada e, em breve, o setor financeiro irá encontrar em contato com você.
      </p>
